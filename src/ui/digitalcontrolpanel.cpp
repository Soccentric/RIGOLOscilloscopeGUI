...
DigitalControlPanel::DigitalControlPanel(const QMap<QString, ScopeChannel*> &channels,
...
void DigitalControlPanel::createAcquisitionTab()
{
    ...
    connect(m_runStopBtn, &QPushButton::clicked, this, &DigitalControlPanel::onRunStopClicked);
    ...
    connect(m_singleBtn, &QPushButton::clicked, this, &DigitalControlPanel::singleClicked);
    acqBtns->addWidget(m_singleBtn);
    
    m_autoBtn = new QPushButton("AUTO");
    m_autoBtn->setObjectName("acqBtn");
    m_autoBtn->setMinimumHeight(36);
    connect(m_autoBtn, &QPushButton::clicked, this, &DigitalControlPanel::autoScaleClicked);
    ...
    connect(m_clearBtn, &QPushButton::clicked, this, &DigitalControlPanel::clearClicked);
...
void DigitalControlPanel::createTriggerTab()
{
    ...
    connect(m_trigSourceCombo, QOverload<int>::of(&QComboBox::currentIndexChanged),
            this, &DigitalControlPanel::onTriggerSourceChanged);
    ...
    connect(m_forceBtn, &QPushButton::clicked, this, &DigitalControlPanel::forceTriggerClicked);
...
void DigitalControlPanel::createMeasurementsTab()
{
    ...
    connect(m_addMeasBtn, &QPushButton::clicked, this, &DigitalControlPanel::onAddMeasurement);
...
void DigitalControlPanel::createAnalysisTab()
{
    ...
    connect(m_fftBtn, &QPushButton::clicked, this, &DigitalControlPanel::fftClicked);
    ...
    connect(m_protocolBtn, &QPushButton::clicked, this, &DigitalControlPanel::protocolDecoderClicked);
...
void DigitalControlPanel::applyStyles()
{
    setStyleSheet(R"(
        ...
        #runStopBtn[running="true"] {
            background-color: #da3633;
        }
        
        #runStopBtn[running="true"]:hover {
...
void DigitalControlPanel::refresh()
{
    updateMeasurementTable();
}

void DigitalControlPanel::onRunStopClicked()
{
    emit runStopClicked();
}
