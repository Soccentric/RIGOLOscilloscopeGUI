...
void MainWindow::createCentralWidget()
{
    ...
    // Connect waveform display signals
    connect(m_waveformDisplay, &WaveformDisplay::toggleCursors, this, [this]() {
        m_cursorAction->setChecked(!m_cursorAction->isChecked());
        // TODO: Implement cursor toggle logic
    });
}
...
void MainWindow::onOpenFFT()
{
    ...
    // Set default source channel (first enabled channel)
